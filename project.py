...
def create_enemy_starcraft(canvas, starcraft, w):
    ...
    y = 0
    starcraft.append(canvas.create_image_with_size(x, y, BALL_RADIUS, BALL_RADIUS,"son2.png"))
...
def images(canvas, h, w):
    image_1 = canvas.create_image_with_size(GAP, h / 2 - GAP, IMAGE_WIDHT, IMAGE_HEIGHT, "starfighter.png"  )
    image_2 = canvas.create_image_with_size(GAP * 2 + IMAGE_WIDHT, h / 2 - GAP, IMAGE_WIDHT, IMAGE_HEIGHT, "starfighter2.png"  )
    image_3 = canvas.create_image_with_size(GAP * 3 + IMAGE_WIDHT * 2, h / 2 - GAP, IMAGE_WIDHT, IMAGE_HEIGHT, "starfighter3.png"  )         
